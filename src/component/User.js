                ...
                <Modal isOpen={this.state.editUserModal} toggle={this.toogleEditUserModal.bind(this)} >
                    ...
                    <ModalBody>
                        ...
                        <FormGroup>
                            ...
                            <Input id="email" value={this.state.editUser.email} onChange={(e) => {
                                let {editUser} = this.state;
                        ...
                        <FormGroup>
                            ...
                            <Input id="firstName" value={this.state.editUser.firstName}  onChange={(e) => {
                                let {editUser} = this.state;
                        ...
                        <FormGroup>
                            ...
                            <Input id="lastName" value={this.state.editUser.lastName} onChange={(e) => {
                                let {editUser} = this.state;
                        ...
                        <FormGroup>
                            ...
                            <Input id="dateOfBirth" value={this.state.editUser.dateOfBirth} type = "date" onChange={(e) => {
                                let {editUser} = this.state;
                        ...
                        <FormGroup>
                            ...
                            <Input id="role" value={this.state.editUser.role} onChange={(e) => {
                                let {editUser} = this.state;
                        ...
                        <FormGroup>
                            ...
                            <Input id="role1" value={this.state.editUser.role1} onChange={(e) => {
                                let {editUser} = this.state;
                    ...
                    <ModalFooter>
                        <Button color="primary" onClick={this.editUser.bind(this)}> Luu</Button>{' '}
                        <Button color="secondary" onClick={this.toogleEditUserModal.bind(this)}>Cancel</Button>
                    </ModalFooter>
                </Modal>
                <Table>
                    <thead>
